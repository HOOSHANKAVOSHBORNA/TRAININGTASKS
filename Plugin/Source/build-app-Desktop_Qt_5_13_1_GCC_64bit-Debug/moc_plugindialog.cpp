...
QT_INIT_METAOBJECT const QMetaObject PluginDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_PluginDialog.data,
    qt_meta_data_PluginDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
